 ...
 * @param {number} serviceWorkerFetchStart Started fetching via ServiceWorker.
 * @param {number} serviceWorkerFetchReady Prepared a ServiceWorker.
 * @param {number} serviceWorkerFetchEnd Finished fetching via ServiceWorker.
...
function ResourceTiming(props) {
  ...
  this.serviceWorkerFetchStart = props.serviceWorkerFetchStart;
  this.serviceWorkerFetchReady = props.serviceWorkerFetchReady;
  this.serviceWorkerFetchEnd = props.serviceWorkerFetchEnd;
