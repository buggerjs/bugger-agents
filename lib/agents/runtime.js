...
function RuntimeAgent(client) {
  ...
  BaseAgent.call(this, RuntimeAgent, client);
}
 ...
 */
RuntimeAgent.prototype.evaluate = function() {
 ...
 * @returns {boolean=} wasThrown True if the result was thrown during the evaluation.
 */
RuntimeAgent.prototype.callFunctionOn = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
RuntimeAgent.prototype.getProperties = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
RuntimeAgent.prototype.releaseObject = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
RuntimeAgent.prototype.releaseObjectGroup = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
RuntimeAgent.prototype.run = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
RuntimeAgent.prototype.enable = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
RuntimeAgent.prototype.disable = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
