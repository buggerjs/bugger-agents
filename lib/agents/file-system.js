...
function FileSystemAgent(client) {
  ...
  BaseAgent.call(this, FileSystemAgent, client);
}
 ...
 */
FileSystemAgent.prototype.enable = function() {
 ...
 */
FileSystemAgent.prototype.disable = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
FileSystemAgent.prototype.requestFileSystemRoot = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
FileSystemAgent.prototype.requestDirectoryContent = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
FileSystemAgent.prototype.requestMetadata = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 */
FileSystemAgent.prototype.requestFileContent = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
 ...
 * @returns {integer} errorCode 0, if no error. Otherwise errorCode is set to FileError::ErrorCode value.
 */
FileSystemAgent.prototype.deleteEntry = function() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
