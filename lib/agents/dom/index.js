...
_.extend(DOMAgent, require('./types'));
...
function getDocument() {
  return this._ignore('getDocument')
    .then(function() {
      return {
        root: {
          nodeId: 1,
...
function setInspectModeEnabled(params) {
  return this._ignore('setInspectModeEnabled', params);
};
...
function hideHighlight() {
  return this._ignore('hideHighlight');
};
 ...
 */
DOMAgent.prototype.setInspectedNode =
 ...
 */
DOMAgent.prototype.getHighlightObjectForTest =
function getHighlightObjectForTest() {
  return this._withClient(function() {
    throw new Error('Not implemented');
  });
};
